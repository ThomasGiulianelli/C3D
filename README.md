...
2. `C3D-v1.0/examples/c3d_feature_extraction/prototxt/extract.py` - this was written in Python because of a Matlab limitation, and it happens to be in a different directory from all the other scripts. Remember to pass `txt` as a parameter.
3. `save_features.m`
4. `save_features_2.m`
